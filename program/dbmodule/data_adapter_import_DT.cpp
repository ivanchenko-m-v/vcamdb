...
{
/// ############################################################################
///			class data_adapter_import_DT
/// ############################################################################

    const QString data_adapter_import_DT::_s_sql_insert(
    ...
    const QString data_adapter_import_DT::_s_sql_delete(
    ...
    /// ========================================================================
	///------------------------------------------------------------------------
    ///	~data_adapter_import_DT( )
    ///------------------------------------------------------------------------
    data_adapter_import_DT::~data_adapter_import_DT( )
	{
	}
    ...
    ///------------------------------------------------------------------------
    void data_adapter_import_DT::throw_error( const char* s_msg ) const
	{
    ...
    ///	make_params_insert
    ///------------------------------------------------------------------------
    void data_adapter_import_DT::make_params_insert(
                                                   ...
                                                   )
    {
        ...
        pcmd->parameters( ).append( new qt_sqlite_dbvalue_text( trim_quotes( s_record.at(5) ) ) );
    }

    ///------------------------------------------------------------------------
    ///	trim_quotes
    ///------------------------------------------------------------------------
    QString data_adapter_import_DT::trim_quotes( const QString &str )
    {
        QString result = str;
        if( result.isEmpty( ) )
        {
    ...
    ///------------------------------------------------------------------------
    void data_adapter_import_DT::insert(
    ...
    {
            //create command
            pcmd = cnn.create_command( data_adapter_import_DT::_s_sql_insert );
            //add parameters
    ...
    ///	exec
    ///------------------------------------------------------------------------
    void data_adapter_import_DT::exec(
    ...
    ///	clear_import_table
    ///------------------------------------------------------------------------
    void data_adapter_import_DT::clear_import_table(
                                    espira::db::qt_sqlite_connection &cnn,
                                    espira::db::qt_sqlite_command *pcmd
                                                   )
    {
        //create command
        this->exec( data_adapter_import_DT::_s_sql_delete, cnn, pcmd );
    }

    ///------------------------------------------------------------------------
    ///	import_file( const QString &f_name ) const
    ///------------------------------------------------------------------------
    void data_adapter_import_DT::import_file( const QString &f_name )
    {
    ...
    ///------------------------------------------------------------------------
    void data_adapter_import_DT::begin_transaction( espira::db::qt_sqlite_connection &cnn )
    {
        espira::db::qt_sqlite_command *pcmd = 0;
    ...
    ///------------------------------------------------------------------------
    void data_adapter_import_DT::commit_transaction( espira::db::qt_sqlite_connection &cnn )
    {
        espira::db::qt_sqlite_command *pcmd = 0;
    ...
    ///------------------------------------------------------------------------
    void data_adapter_import_DT::rollback_transaction( espira::db::qt_sqlite_connection &cnn )
    {
        espira::db::qt_sqlite_command *pcmd = 0;
