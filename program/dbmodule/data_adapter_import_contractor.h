...
///		Comment		:
/// ============================================================================
#ifndef __DATA_ADAPTER_IMPORT_CONTRACTOR_H__
#define __DATA_ADAPTER_IMPORT_CONTRACTOR_H__
...
/// ############################################################################
	...
	private:
    /// ------------------------------------------------------------------------
        data_adapter_import_contractor( const data_adapter_import_contractor &rhs );

	public:
    /// ------------------------------------------------------------------------
        explicit data_adapter_import_contractor( espira::db::qt_sqlite_connection *pdbms = 0 ) :
			_dbms( pdbms )
		 { }
    /// ------------------------------------------------------------------------
    ...
    /// ========================================================================
    private:
        data_adapter_import_contractor& operator=( const data_adapter_import_contractor &rhs );
...
#endif // __DATA_ADAPTER_IMPORT_CONTRACTOR_H__
