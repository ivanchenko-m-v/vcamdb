...
///		Comment		:
/// ============================================================================
#ifndef __DATA_ADAPTER_IMPORT_RESPONSE_H__
#define __DATA_ADAPTER_IMPORT_RESPONSE_H__
...
/// ############################################################################
	...
	private:
    /// ------------------------------------------------------------------------
        data_adapter_import_response( const data_adapter_import_response &rhs );

	public:
    /// ------------------------------------------------------------------------
        explicit data_adapter_import_response( espira::db::qt_sqlite_connection *pdbms = 0 ) :
			_dbms( pdbms )
		 { }
    /// ------------------------------------------------------------------------
    ...
    /// ========================================================================
    private:
        data_adapter_import_response& operator=( const data_adapter_import_response &rhs );
...
#endif // __DATA_ADAPTER_IMPORT_RESPONSE_H__
