...
///		Comment		:
/// ============================================================================
#ifndef __DATA_ADAPTER_IMPORT_VIOLATION_TYPE_H__
#define __DATA_ADAPTER_IMPORT_VIOLATION_TYPE_H__
...
/// ############################################################################
	...
	private:
    /// ------------------------------------------------------------------------
        data_adapter_import_violation_type( const data_adapter_import_violation_type &rhs );

	public:
    /// ------------------------------------------------------------------------
        explicit data_adapter_import_violation_type( espira::db::qt_sqlite_connection *pdbms = 0 ) :
			_dbms( pdbms )
		 { }
    /// ------------------------------------------------------------------------
    ...
    /// ========================================================================
    private:
        data_adapter_import_violation_type& operator=( const data_adapter_import_violation_type &rhs );
...
#endif // __DATA_ADAPTER_IMPORT_VIOLATION_TYPE_H__
