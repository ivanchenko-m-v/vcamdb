...
{
/// ############################################################################
///			class data_adapter_import_contractor
/// ############################################################################

    const QString data_adapter_import_contractor::_s_sql_insert(
                                "INSERT INTO t_contractor "
                                "(OBJECT_TYPE, x_contractor)"
                                "   VALUES(:x_type, :x_contractor);"
                                                );

    const QString data_adapter_import_contractor::_s_sql_delete(
    ...
    ///------------------------------------------------------------------------
    data_adapter_import_contractor::~data_adapter_import_contractor( )
	{
	}
    ...
    ///------------------------------------------------------------------------
    void data_adapter_import_contractor::throw_error( const char* s_msg ) const
	{
    ...
    ///	make_params_insert
    ///------------------------------------------------------------------------
    void data_adapter_import_contractor::make_params_insert(
    ...
    ///	trim_quotes
    ///------------------------------------------------------------------------
    QString data_adapter_import_contractor::trim_quotes( const QString &str )
    {
        QString result = str;
        if( result.isEmpty( ) )
        {
    ...
    ///------------------------------------------------------------------------
    void data_adapter_import_contractor::insert(
    ...
    {
            //create command
            pcmd = cnn.create_command( data_adapter_import_contractor::_s_sql_insert );
            //add parameters
    ...
    ///	exec
    ///------------------------------------------------------------------------
    void data_adapter_import_contractor::exec(
    ...
    ///	clear_import_table
    ///------------------------------------------------------------------------
    void data_adapter_import_contractor::clear_import_table(
                                    espira::db::qt_sqlite_connection &cnn,
                                    espira::db::qt_sqlite_command *pcmd
                                                   )
    {
        //create command
        this->exec( data_adapter_import_contractor::_s_sql_delete, cnn, pcmd );
    }

    ///------------------------------------------------------------------------
    ///	import_file( const QString &f_name ) const
    ///------------------------------------------------------------------------
    void data_adapter_import_contractor::import_file( const QString &f_name )
    {
    ...
    ///------------------------------------------------------------------------
    void data_adapter_import_contractor::begin_transaction( espira::db::qt_sqlite_connection &cnn )
    {
        espira::db::qt_sqlite_command *pcmd = 0;
    ...
    ///------------------------------------------------------------------------
    void data_adapter_import_contractor::commit_transaction( espira::db::qt_sqlite_connection &cnn )
    {
        espira::db::qt_sqlite_command *pcmd = 0;
    ...
    ///------------------------------------------------------------------------
    void data_adapter_import_contractor::rollback_transaction( espira::db::qt_sqlite_connection &cnn )
    {
        espira::db::qt_sqlite_command *pcmd = 0;
