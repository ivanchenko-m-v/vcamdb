...
{
/// ############################################################################
///			class data_adapter_import_CA
/// ############################################################################

    const QString data_adapter_import_CA::_s_sql_insert(
    ...
    const QString data_adapter_import_CA::_s_sql_delete(
    ...
    /// ========================================================================
	///------------------------------------------------------------------------
    ///	~data_adapter_import_CA( )
    ///------------------------------------------------------------------------
    data_adapter_import_CA::~data_adapter_import_CA( )
	{
	}
    ...
    ///------------------------------------------------------------------------
    void data_adapter_import_CA::throw_error( const char* s_msg ) const
	{
    ...
    ///	make_params_insert
    ///------------------------------------------------------------------------
    void data_adapter_import_CA::make_params_insert(
    ...
    ///	trim_quotes
    ///------------------------------------------------------------------------
    QString data_adapter_import_CA::trim_quotes( const QString &str )
    {
        QString result = str;
        if( result.isEmpty( ) )
        {
    ...
    ///------------------------------------------------------------------------
    void data_adapter_import_CA::insert(
    ...
    {
            //create command
            pcmd = cnn.create_command( data_adapter_import_CA::_s_sql_insert );
            //add parameters
    ...
    ///	exec
    ///------------------------------------------------------------------------
    void data_adapter_import_CA::exec(
    ...
    ///	clear_import_table
    ///------------------------------------------------------------------------
    void data_adapter_import_CA::clear_import_table(
                                    espira::db::qt_sqlite_connection &cnn,
                                    espira::db::qt_sqlite_command *pcmd
                                                   )
    {
        //create command
        this->exec( data_adapter_import_CA::_s_sql_delete, cnn, pcmd );
    }

    ///------------------------------------------------------------------------
    ///	import_file( const QString &f_name ) const
    ///------------------------------------------------------------------------
    void data_adapter_import_CA::import_file( const QString &f_name )
    {
    ...
    ///------------------------------------------------------------------------
    void data_adapter_import_CA::begin_transaction( espira::db::qt_sqlite_connection &cnn )
    {
        espira::db::qt_sqlite_command *pcmd = 0;
    ...
    ///------------------------------------------------------------------------
    void data_adapter_import_CA::commit_transaction( espira::db::qt_sqlite_connection &cnn )
    {
        espira::db::qt_sqlite_command *pcmd = 0;
    ...
    ///------------------------------------------------------------------------
    void data_adapter_import_CA::rollback_transaction( espira::db::qt_sqlite_connection &cnn )
    {
        espira::db::qt_sqlite_command *pcmd = 0;
