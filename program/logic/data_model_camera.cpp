...
/// ############################################################################
    ...
    ///	data_model_camera( )
	/// ------------------------------------------------------------------------
    data_model_camera::data_model_camera( QObject *pobj/* = 0*/ ) :
    ...
    ///	~data_model_camera( )
	/// ------------------------------------------------------------------------
    data_model_camera::~data_model_camera( )
	{
		this->clear( );

        qDebug( ) << "data_model_camera cleared correctly";
	}
	...
	/// ------------------------------------------------------------------------
/*
    const data_request* data_model_camera::request( int i_row ) const
	{
...
*/
	...
	///	initialize( )
	/// ------------------------------------------------------------------------
    void data_model_camera::initialize( )
	{
	...
	/// ------------------------------------------------------------------------
    void data_model_camera::refresh(const QVector<QVector<QVariant> > &data)
	{
		this->clear( );
...
/*
	...
	/// ------------------------------------------------------------------------
 /*
    void data_model_camera::refresh( data_request_collection *data )
	{
		this->clear( );
    ...
    */
	...
	/// ------------------------------------------------------------------------
/*
    void data_model_camera::insert( const data_request &request )
    {
    ...
    */
	...
	///	data( )
	/// ------------------------------------------------------------------------
    QVariant data_model_camera::data(
	...
	///	setData( )
	/// ------------------------------------------------------------------------
    bool data_model_camera::setData(
										const QModelIndex &/*index*/,
	...
	///	flags( )
	/// ------------------------------------------------------------------------
    Qt::ItemFlags data_model_camera::flags(const QModelIndex &/*index*/) const
	{
	...
	///	insertRows( )
	/// ------------------------------------------------------------------------
    bool data_model_camera::insertRows(
								int row, int count,
	...
	///	insertRows( )
	/// ------------------------------------------------------------------------
    bool data_model_camera::removeRows(
								int row, int count,
								const QModelIndex &parent //= QModelIndex( )
										 )
	{
